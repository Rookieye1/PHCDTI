...
import gc
import argparse
from FuxiCTR_Project.FuxiCTR.fuxictr import autotuner

if __name__ == '__main__':
    config_ids = [
        # "../config/ctrmodel_in_criteo&avazu/tuner_phn_criteo.yaml",
        "../config/ctrmodel_in_criteo&avazu/tuner_phn_avazu.yaml"
    ]
    for config_id in config_ids:
        parser = argparse.ArgumentParser()
        parser.add_argument('--version', type=str, default='pytorch', help='The model version.')
        parser.add_argument('--config', type=str, default=config_id,
                            help='The config file for param tuning.')
